...
public class MonsterArenaRepository {
    ...
    public void getMonsterByType(String type){
        MonsterArenaDatabase.databaseWriteExecutor.execute(() -> {
                monstersDAO.getMonsterByType(type);
        });
    }

    public void  getMonsterByUserID(Integer user_id){
        MonsterArenaDatabase.databaseWriteExecutor.execute(() ->{
            monstersDAO.getMonsterByUserId(user_id);
        });
    }
